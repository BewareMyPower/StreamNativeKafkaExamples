...
public class TokenProducerExample {
    ...
    public static void main(String[] args) throws InterruptedException {
        final String token = "eyJhbGciOiJSUzI1NiIsImtpZCI6InB1YmxpYzpoeWRyYS5qd3QuYWNjZXNzLXRva2VuIiwidHlwIjoiSldUIn0.eyJh"
        ...
        props.put("sasl.jaas.config", String.format("org.apache.kafka.common.security.plain.PlainLoginModule\n"
